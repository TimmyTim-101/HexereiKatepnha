...
<img width="600" height="163" alt="KatepиHa_title" src="https://github.com/user-attachments/assets/f7877327-3da0-4865-b7e1-45072d632987" />

***

## 免责声明 / Disclaimer

* 本项目为一个纯免费、开源的玩家自制交流学习项目，禁止用于任何商业用途。
* 本项目与米哈游（miHoYo）以及 Cognosphere PTE. LTD. 无任何官方联系或附属关系。
* 项目中使用的所有游戏相关图像、图标、文本、数据以及《原神》（Genshin Impact）的相关资产与设计，其版权均归属于上海米哈游（miHoYo）及其关联公司或 Cognosphere PTE. LTD. 所有。
* 任何查阅、使用及二次修改本项目的用户，请您遵守米哈游的玩家创作者公约及相关许可条款。如果本项目存在任何侵权问题，请联系我删除。

## 使用说明
1. 前往[Release](https://github.com/TimmyTim-101/HexereiKatepnha/releases)页面下载最新程序压缩包
2. 解压缩到任意文件夹
3. 点击可执行程序**HexereiKatepnha.exe**运行程序

> [!IMPORTANT]
> Release本身不包含用户数据<br>
> 请通过手动移动旧版本程序所在文件夹中**Configs**文件夹到新版本程序所在文件夹中来迁移用户数据

## 致谢与参考资料

感谢以下项目与个人组织对本项目提供的内容参考（排名不分先后）：

#### 特别鸣谢
* [Katepиha](https://github.com/TimmyTim-101/katepnha)
#### 数据库类项目
* [安柏计划](https://ambr.top/)
